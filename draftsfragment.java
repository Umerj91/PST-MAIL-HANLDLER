...
public class draftsfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate( R.layout.fragment_draftsfragment, container, false );
        setHasOptionsMenu(true);
        View view= inflater.inflate( R.layout.fragment_draftsfragment,container, false );
        ...
        MyAdapter adapter = new MyAdapter(getContext(),dbHelper.RecordsbyId(id));
