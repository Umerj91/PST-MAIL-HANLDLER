...
public class Reply extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener{
...
//                                            + sPath));
        ...
        btniattach.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(Reply.this, btniattach);
...
//For Options Menu
        btnoptions.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popup = new PopupMenu(Reply.this, view);
                popup.setOnMenuItemClickListener(Reply.this);
